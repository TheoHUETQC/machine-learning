...
class MLP :
    def __init__(self, perceptron_by_layer = [2,3,1], activation_fonction = ['relu','relu','relu']) :
        self.perceptron_by_layer = perceptron_by_layer
        self.activation_fonction = activation_fonction
        self.layers = [Layer(perceptron_by_layer[i], perceptron_by_layer[i + 1], activation_fonction[i])
